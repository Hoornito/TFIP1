...
namespace Sistema_Receptor.Receiver
{
    public class DocumentReceiver<T> : BackgroundService where T : class
    {
        ...
        public DocumentReceiver(MessageManager messageManager, MessageManagerSettings messageManagerSettings, QueueSettings settings, ILogger<DocumentReceiver<T>> logger, IServiceProvider serviceProvider)
        {
            ...
            queueName = settings.Queues.FirstOrDefault(q => q.Type == typeof(Documentos)).Type.Name;
        }
